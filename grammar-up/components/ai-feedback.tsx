...
export function AIFeedback({ question, userAnswer, correctAnswer, questionType, show, onLoadingChange }: AIFeedbackProps) {
  ...
  }, [question, userAnswer, correctAnswer, questionType, onLoadingChange]) // ← Thêm dependencies
  ...
  }, [show, userAnswer, correctAnswer, fetchFeedback]) // ← Thêm fetchFeedback
      ...
      <div className="flex items-start gap-3 md:gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-2">
            ...
            {remainingRequests !== null && !isLimitReached && (
